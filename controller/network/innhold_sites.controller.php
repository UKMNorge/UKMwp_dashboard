<?php
	...
	$site->ID = UKM_HOSTNAME_SUBDOMAIN == 'ukm.dev' ? 586 : 3449;
	$site->title = 'redaksjonelt';
	$site->link_add = '//'. UKM_HOSTNAME_SUBDOMAIN .'/redaksjonelt/wp-admin/post-new.php';
	$site->link_panel = '//'. UKM_HOSTNAME_SUBDOMAIN .'/redaksjonelt/wp-admin/';
	...
	$site = new stdClass();
	$site->key = 'arrangor';
	$site->ID = UKM_HOSTNAME_SUBDOMAIN == 'ukm.dev' ? 13 : 881;
	$site->title = 'arrangører';
	$site->link_add = '//'. UKM_HOSTNAME_SUBDOMAIN .'/arrangor/wp-admin/post-new.php';
	$site->link_panel = '//'. UKM_HOSTNAME_SUBDOMAIN .'/arrangor/wp-admin/';
	...
	$site->ID = UKM_HOSTNAME_SUBDOMAIN== 'ukm.dev' ? 535 : 3447;
	$site->title = 'organisasjonen';
	$site->link_add = '//'. UKM_HOSTNAME_SUBDOMAIN .'/org/wp-admin/post-new.php';
	$site->link_panel = '//'. UKM_HOSTNAME_SUBDOMAIN .'/org/wp-admin/';
	...
	$site->ID = 2174;
	$site->title = 'Media';
	$site->link_add = '//'. UKM_HOSTNAME_SUBDOMAIN .'/media/wp-admin/post-new.php';
	$site->link_panel = '//'. UKM_HOSTNAME_SUBDOMAIN .'/media/wp-admin/';
	...
	$site->ID = UKM_HOSTNAME_SUBDOMAIN == 'ukm.dev' ? 580 : 7830;
	$site->title = 'UKM-festivalen 2023';
	$site->link_add = '//'. UKM_HOSTNAME_SUBDOMAIN .'/festivalen-arkiv-2023/wp-admin/post-new.php';
	$site->link_panel = '//'. UKM_HOSTNAME_SUBDOMAIN .'/festivalen-arkiv-2023/wp-admin/';
	if( date('m') < 7 && date('m') > 4 ) {
		$site->frequency = 10; #days
		$site->status = post_status( $site );
	} else {
...
#	$site->link_add = '//'. UKM_HOSTNAME .'/wp-admin/post-new.php';
	$site->link_panel = '//'. UKM_HOSTNAME_SUBDOMAIN .'/wp-admin/';
